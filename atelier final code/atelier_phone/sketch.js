...
function setup()
{
 ...
 dataServer = new PubNub(
 {
  ...
  dataServer.subscribe({channels: [channelName]});
    ...
    sendText.position(windowWidth/2-100,height+210);
    sendButton.position(sendText.x + sendText.width,height+210);
...
if(num>total){
  ...
  sendText.position(0,800);
  sendButton.position(0,800);
  sendText.scale(0);
  sendButton.scale(0);
  }
    ...
    document.getElementById("display").style.fontSize = '175%';
    document.getElementById("display").innerHTML =(blank[num+1]);
  }
}
